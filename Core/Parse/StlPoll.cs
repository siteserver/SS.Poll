...
namespace SS.Poll.Core.Parse
{
    public static class StlPoll
    {
        ...
        public static string Parse(IParseContext context)
        {
            ...
            var pollInfo = PollManager.GetPollInfo(context.SiteId, context.ChannelId, context.ContentId);
...
";
            ...
            var pluginUrl = Context.PluginApi.GetPluginUrl(PollUtils.PluginId, "assets");
            var pluginUrlCss = Context.PluginApi.GetPluginUrl(PollUtils.PluginId, "css");
            var apiUrlSubmit = $"{Context.Environment.ApiUrl}/{PollUtils.PluginId}/{pollInfo.Id}";
            var imgUrl = $"{Context.Environment.ApiUrl}/{PollUtils.PluginId}/code/{pollInfo.Id}";
            ...
            {
                var fieldHtml = string.Empty;//FieldTypeParser.Parse(fieldInfo);

                //                    if (fieldInfo.IsValidate && fieldInfo.IsRequired)
                //                    {
                //                        builder.Append($@"
                //<li>
