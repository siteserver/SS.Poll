...
";
        ...
        public static string GetValidateAttributes(bool isValidate, string displayName, bool isRequire, int minNum, int maxNum, string validateType, string errorMessage)
        {
            var validateAttributes = string.Empty;
            if (isValidate)
            {
                validateAttributes =
                    $@"isValidate=""{true.ToString().ToLower()}"" displayName=""{displayName}"" isRequire=""{isRequire.ToString().ToLower()}"" minNum=""{minNum}"" maxNum=""{maxNum}"" validateType=""{validateType}"" errorMessage=""{errorMessage}""";
            }
            return validateAttributes;
        }

        public static void GetValidateAttributesForListItem(ListControl control, bool isValidate, string displayName, bool isRequire, int minNum, int maxNum, string validateType, string errorMessage)
        {
