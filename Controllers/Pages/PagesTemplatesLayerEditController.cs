    ...
    public class PagesTemplatesLayerEditController : ApiController
    {
        ...
        public IHttpActionResult Edit()
        {
            try
            {
                ...
                if (PollUtils.EqualsIgnoreCase(originalName, name))
                {
                    var templateInfoList = TemplateManager.GetTemplateInfoList(type);
                    var originalTemplateInfo = templateInfoList.First(x => PollUtils.EqualsIgnoreCase(originalName, x.Name));
        ...
        //        var templateInfoList = TemplateManager.GetTemplateInfoList();
        //        var templateInfoToClone = templateInfoList.FirstOrDefault(x => PollUtils.EqualsIgnoreCase(nameToClone, x.Name));
